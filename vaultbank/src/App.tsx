              ...
              <section className="hero">
                <div className="heroInner">
                  <div className="heroLeft">
                    ...
                    <p className="lead">
                      a clean, modern banking experience: real-time controls, spending insights, and
                  ...
                  <div>
                    ...
                    <div className="bullets">
                      <div className="bullet">
                        <span className="check">✓</span> instant freeze + limits
                      </div>
                      <div className="bullet">
                        <span className="check">✓</span> device + session monitoring
                      </div>
                      <div className="bullet">
                        <span className="check">✓</span> exportable activity logs
                      </div>
                    </div>
                    ...
                    <div className="callout">
                      ...
                      <div className="sub">
                        keep utilization under ~30% for a cleaner profile long-term.
                      </div>
                    </div>
                  </div>
